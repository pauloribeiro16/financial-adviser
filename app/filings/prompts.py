...
Read the section text below and produce a structured summary (<=500 chars) with:
...
Read the text below and produce a structured summary (<=500 chars) listing the TOP 5 RISKS,
...
- No padding. Output ONLY the ranked list.
...
Read the text below and produce a structured summary (<=500 chars) of:
